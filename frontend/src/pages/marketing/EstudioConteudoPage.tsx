...
import { AlertCircle, Brain, CalendarClock, Camera, Check, ChevronRight, Download, ExternalLink, Lightbulb, Loader2, MessageSquarePlus, Plus, RefreshCw, Send, Sparkles, ThumbsDown, ThumbsUp, Trash2, Upload, X } from 'lucide-react';
